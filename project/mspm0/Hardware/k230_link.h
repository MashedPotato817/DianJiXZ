...
/* UART2 最小联调协议：$K230,BALL,<x_mm>,<valid>,<seq># */
...
/* 最小联调 LED 指示：至少尝试过一次 UART2 发送时返回 1。 */
uint8_t K230_Link_HasTxAttempt(void);
/* UART2 PB17->PB18 回环测试：收到自身 HELLO 帧时返回 1。 */
uint8_t K230_Link_IsLocalLoopbackDetected(void);
/* 至少从 UART2 FIFO 读出过一个字节时返回 1，不要求帧格式正确。 */
